...
export default function Goals() {
  ...
  function addItem() {
    var modal = bootstrap.Modal.getOrCreateInstance(document.querySelector('.addItemModal'))
    modal.show();
  }
  ...
  function showEditItem(id) {
    ...
    var modal = bootstrap.Modal.getOrCreateInstance(document.querySelector('.editItemModal'))
    modal.show();
  }
